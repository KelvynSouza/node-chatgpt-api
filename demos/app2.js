...
const options = {
    ...
    userToken: '1iEa1X6n5Bp6MXHXULdjMP7Zn7bg2yTLbFBfwYBXM6N54errKUJ7dW2YK5t3V9ExT1egFgIfa9gq1Hxb32Z4OwL0sJQO28tvnnYz3aFEVfrP2FPCxY1RpRkIBIPbIaxnszdk4dzzawSuHvXKcudT-ufzSEHnAg7_98ocMLs-ksF098UUq4RerfqtRxXGhIuBog9rMNLE68yXolOhMqUNQz4mI8em39dYr1D5VOCsY4FU',
...
const directoryPath = path.join(__dirname, '../translation_source/Infinity Mage Chapters2');
...
if (files.length > 0) {
    for (let index = 0; index < files.length; index++) {
        ...
        try {
            ...
            fs.writeFileSync(`C:/git/node-chatgpt-api/translated/Infinity Mage Chapters2/${fileName}`, translatedFileText);
