...
const options = {
    ...
    userToken: '1NTfeDwckJfFAcpmnT9wEk3O5ep6EKqTuEwvsaeNLCj-NP9lM46Znc--a1dWlO4RvsuMOPRcuDQDBjkrBFJv0Eb_VUfozt5CFTVDbcQnVKv9t0WMXFeKnDXwHHEN_QPdqwRYoVb9OoxzM_IS05xgcmdmINR4fMXr9TcDvwY4vJEtBimNkYQC81XeqwkHof3UAQcdUUYYqsJH0glg7uSomsHSn33VxlJ-quCvJOCL-9K01NTfeDwckJfFAcpmnT9wEk3O5ep6EKqTuEwvsaeNLCj-NP9lM46Znc--a1dWlO4RvsuMOPRcuDQDBjkrBFJv0Eb_VUfozt5CFTVDbcQnVKv9t0WMXFeKnDXwHHEN_QPdqwRYoVb9OoxzM_IS05xgcmdmINR4fMXr9TcDvwY4vJEtBimNkYQC81XeqwkHof3UAQcdUUYYqsJH0glg7uSomsHSn33VxlJ-quCvJOCL-9K0',
...
const directoryPath = path.join(__dirname, '../translation_source/Infinity Mage Chapters');
...
if (files.length > 0) {
    for (let index = 0; index < files.length; index++) {
        ...
        try {
            ...
            fs.writeFileSync(`C:/git/node-chatgpt-api/translated/Infinity Mage Chapters/${fileName}`, translatedFileText);
